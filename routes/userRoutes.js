...
import { addQty, address, addToCart, allOrder, cancelorder, cart, checkout, clearCart, createReview, order, placeOrder, profile, removeQty, updateAdd, updateUser } from "../controllers/user.controllers.js";
...
router.post("/review/:productId", verifyUser, createReview);
